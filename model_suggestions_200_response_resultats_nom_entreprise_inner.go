...
// checks if the Suggestions200ResponseResultatsNomEntrepriseInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Suggestions200ResponseResultatsNomEntrepriseInner{}

// Suggestions200ResponseResultatsNomEntrepriseInner struct for Suggestions200ResponseResultatsNomEntrepriseInner
type Suggestions200ResponseResultatsNomEntrepriseInner struct {
...
func NewSuggestions200ResponseResultatsNomEntrepriseInner() *Suggestions200ResponseResultatsNomEntrepriseInner {
	this := Suggestions200ResponseResultatsNomEntrepriseInner{}
	return &this
}
...
func (o Suggestions200ResponseResultatsNomEntrepriseInner) MarshalJSON() ([]byte, error) {
...
func (o Suggestions200ResponseResultatsNomEntrepriseInner) ToMap() (map[string]interface{}, error) {
...
type NullableSuggestions200ResponseResultatsNomEntrepriseInner struct {
	value *Suggestions200ResponseResultatsNomEntrepriseInner
	isSet bool
}

func (v NullableSuggestions200ResponseResultatsNomEntrepriseInner) Get() *Suggestions200ResponseResultatsNomEntrepriseInner {
	return v.value
}

func (v *NullableSuggestions200ResponseResultatsNomEntrepriseInner) Set(val *Suggestions200ResponseResultatsNomEntrepriseInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSuggestions200ResponseResultatsNomEntrepriseInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSuggestions200ResponseResultatsNomEntrepriseInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSuggestions200ResponseResultatsNomEntrepriseInner(val *Suggestions200ResponseResultatsNomEntrepriseInner) *NullableSuggestions200ResponseResultatsNomEntrepriseInner {
	return &NullableSuggestions200ResponseResultatsNomEntrepriseInner{value: val, isSet: true}
}

func (v NullableSuggestions200ResponseResultatsNomEntrepriseInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSuggestions200ResponseResultatsNomEntrepriseInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
