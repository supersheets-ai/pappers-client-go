...
// checks if the EntrepriseFicheAllOfDetailsVotesIndirectsDetailsEnIndivision type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntrepriseFicheAllOfDetailsVotesIndirectsDetailsEnIndivision{}

// EntrepriseFicheAllOfDetailsVotesIndirectsDetailsEnIndivision Détails des droits de vote détenus de façon indirecte par le biais d'une indivision par le bénéficiaire effectif.
type EntrepriseFicheAllOfDetailsVotesIndirectsDetailsEnIndivision struct {
...
func NewEntrepriseFicheAllOfDetailsVotesIndirectsDetailsEnIndivision() *EntrepriseFicheAllOfDetailsVotesIndirectsDetailsEnIndivision {
	this := EntrepriseFicheAllOfDetailsVotesIndirectsDetailsEnIndivision{}
	return &this
}
...
func (o EntrepriseFicheAllOfDetailsVotesIndirectsDetailsEnIndivision) MarshalJSON() ([]byte, error) {
...
func (o EntrepriseFicheAllOfDetailsVotesIndirectsDetailsEnIndivision) ToMap() (map[string]interface{}, error) {
...
type NullableEntrepriseFicheAllOfDetailsVotesIndirectsDetailsEnIndivision struct {
	value *EntrepriseFicheAllOfDetailsVotesIndirectsDetailsEnIndivision
	isSet bool
}

func (v NullableEntrepriseFicheAllOfDetailsVotesIndirectsDetailsEnIndivision) Get() *EntrepriseFicheAllOfDetailsVotesIndirectsDetailsEnIndivision {
	return v.value
}

func (v *NullableEntrepriseFicheAllOfDetailsVotesIndirectsDetailsEnIndivision) Set(val *EntrepriseFicheAllOfDetailsVotesIndirectsDetailsEnIndivision) {
	v.value = val
	v.isSet = true
}

func (v NullableEntrepriseFicheAllOfDetailsVotesIndirectsDetailsEnIndivision) IsSet() bool {
	return v.isSet
}

func (v *NullableEntrepriseFicheAllOfDetailsVotesIndirectsDetailsEnIndivision) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntrepriseFicheAllOfDetailsVotesIndirectsDetailsEnIndivision(val *EntrepriseFicheAllOfDetailsVotesIndirectsDetailsEnIndivision) *NullableEntrepriseFicheAllOfDetailsVotesIndirectsDetailsEnIndivision {
	return &NullableEntrepriseFicheAllOfDetailsVotesIndirectsDetailsEnIndivision{value: val, isSet: true}
}

func (v NullableEntrepriseFicheAllOfDetailsVotesIndirectsDetailsEnIndivision) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntrepriseFicheAllOfDetailsVotesIndirectsDetailsEnIndivision) UnmarshalJSON(src []byte) error {
	v.isSet = true
