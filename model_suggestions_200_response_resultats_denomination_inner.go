...
// checks if the Suggestions200ResponseResultatsDenominationInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Suggestions200ResponseResultatsDenominationInner{}

// Suggestions200ResponseResultatsDenominationInner struct for Suggestions200ResponseResultatsDenominationInner
type Suggestions200ResponseResultatsDenominationInner struct {
...
func NewSuggestions200ResponseResultatsDenominationInner() *Suggestions200ResponseResultatsDenominationInner {
	this := Suggestions200ResponseResultatsDenominationInner{}
	return &this
}
...
func (o Suggestions200ResponseResultatsDenominationInner) MarshalJSON() ([]byte, error) {
...
func (o Suggestions200ResponseResultatsDenominationInner) ToMap() (map[string]interface{}, error) {
...
type NullableSuggestions200ResponseResultatsDenominationInner struct {
	value *Suggestions200ResponseResultatsDenominationInner
	isSet bool
}

func (v NullableSuggestions200ResponseResultatsDenominationInner) Get() *Suggestions200ResponseResultatsDenominationInner {
	return v.value
}

func (v *NullableSuggestions200ResponseResultatsDenominationInner) Set(val *Suggestions200ResponseResultatsDenominationInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSuggestions200ResponseResultatsDenominationInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSuggestions200ResponseResultatsDenominationInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSuggestions200ResponseResultatsDenominationInner(val *Suggestions200ResponseResultatsDenominationInner) *NullableSuggestions200ResponseResultatsDenominationInner {
	return &NullableSuggestions200ResponseResultatsDenominationInner{value: val, isSet: true}
}

func (v NullableSuggestions200ResponseResultatsDenominationInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSuggestions200ResponseResultatsDenominationInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
