...
// checks if the Suggestions200ResponseResultatsSiretInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Suggestions200ResponseResultatsSiretInner{}

// Suggestions200ResponseResultatsSiretInner struct for Suggestions200ResponseResultatsSiretInner
type Suggestions200ResponseResultatsSiretInner struct {
...
func NewSuggestions200ResponseResultatsSiretInner() *Suggestions200ResponseResultatsSiretInner {
	this := Suggestions200ResponseResultatsSiretInner{}
	return &this
}
...
func (o Suggestions200ResponseResultatsSiretInner) MarshalJSON() ([]byte, error) {
...
func (o Suggestions200ResponseResultatsSiretInner) ToMap() (map[string]interface{}, error) {
...
type NullableSuggestions200ResponseResultatsSiretInner struct {
	value *Suggestions200ResponseResultatsSiretInner
	isSet bool
}

func (v NullableSuggestions200ResponseResultatsSiretInner) Get() *Suggestions200ResponseResultatsSiretInner {
	return v.value
}

func (v *NullableSuggestions200ResponseResultatsSiretInner) Set(val *Suggestions200ResponseResultatsSiretInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSuggestions200ResponseResultatsSiretInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSuggestions200ResponseResultatsSiretInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSuggestions200ResponseResultatsSiretInner(val *Suggestions200ResponseResultatsSiretInner) *NullableSuggestions200ResponseResultatsSiretInner {
	return &NullableSuggestions200ResponseResultatsSiretInner{value: val, isSet: true}
}

func (v NullableSuggestions200ResponseResultatsSiretInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSuggestions200ResponseResultatsSiretInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
